...
::: tip
For more information on MeiliSearch authentication and API keys see the [authentication docs](/reference/features/authentication.md). For more information on MeiliSearch options and flags see the [installation docs](/learn/getting_started/quick_start.md#step-1-setup-and-installation).
:::
