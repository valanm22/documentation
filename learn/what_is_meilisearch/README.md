...
- **RESTful API**
- [Integrated search preview](/reference/features/web_interface.md): allows you to test your search settings without implementing a front-end
...
![search preview](/web-interface.png)
